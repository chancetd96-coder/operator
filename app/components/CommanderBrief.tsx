    ...
    >
      ...
      <p className="mt-2 text-sm text-white/45">
        {new Intl.DateTimeFormat("en-US", {
          ...
          month: "short",
          day: "numeric",
          hour: brief.nextMeeting.meeting.time
            ? "numeric"
            : undefined,
          minute: brief.nextMeeting.meeting.time
            ? "2-digit"
            : undefined,
        }).format(new Date(brief.nextMeeting.scheduledAt))}
      </p>

      {brief.nextMeeting.meeting.notes ? (
